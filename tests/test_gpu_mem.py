...
'''
conda activate wocao
export CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7
nohup /maindata/data/shared/public/yangchao.zhou/anaconda3/envs/wocao/bin/python /maindata/data/shared/public/yangchao.zhou/projects/LLaMA-Factory/tests/test_gpu_mem.py > test_gpu_mem.log 2>&1 &
ps -ef | grep test_gpu_mem.py
...
def monitor_gpu_utilization(interval=3600):
    """
...
if __name__ == "__main__":
    ...
    # 启动监控线程
    monitor_thread = Thread(target=monitor_gpu_utilization, args=(3600,), daemon=True)
