...
nohup /root/miniconda3/envs/nemo/bin/python /maindata/data/shared/public/yangchao.zhou/projects/LLaMA-Factory/tests/test_gpu.py > test_gpu.log 2>&1 &
ps -ef | grep test_gpu.py
'''
